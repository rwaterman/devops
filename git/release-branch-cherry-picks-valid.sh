#!/bin/bash
#set -xe
# This is a "Witch Hunt"TM ⛧ script that uncovers contribitor commits that were not properly cherry-picked for a hotfix release branch, causing many merge conflicts or other types of unexpected chaos. Always find secondary proof before accusing someone and use this script at your own peril. Assumes branch merge strategy: Squash and merge. 🤘
